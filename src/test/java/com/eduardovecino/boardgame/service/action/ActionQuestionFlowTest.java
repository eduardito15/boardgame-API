...
@SpringBootTest
public class ActionQuestionFlowTest {
    ...
    public void setUp() {
        ...
        Mockito.when(actionFactory.getInstance(any(), any()))
                .thenReturn(new MinesweeperActionQuestionImpl());
    }


    @Test
    public void testQuestionSquare() {
        ActionRequestDTO actionRequestDTO = new ActionRequestDTO();
        actionRequestDTO.setAction(ActionsEnum.QUESTION);
        ...
        Assert.assertEquals("Not expected board result", new HashSet<>(Arrays.asList(createMinesweeperSquare(0,2,
                false, false, 1, false, true))), action.getBoardResult());
    }

    @Test
    public void testUnQuestionSquare() {
        ActionRequestDTO actionRequestDTO = new ActionRequestDTO();
        actionRequestDTO.setAction(ActionsEnum.QUESTION);
        actionRequestDTO.setGameId("GID-TEST");
        actionRequestDTO.setRow(0);
        actionRequestDTO.setColumn(3);
        actionRequestDTO.setTimeMin(0);
        ...
        Assert.assertEquals("Not expected board result", new HashSet<>(Arrays.asList(
                createMinesweeperSquare(0,3, false, false, 3, false, false))), action.getBoardResult());
    }
    ...
    private Board getGameTestBoard() {
        ...
        board.updateSquare(0,3, createMinesweeperSquare(0,3, false, false, 3, false, true));
